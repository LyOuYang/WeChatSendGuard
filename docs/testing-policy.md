...
- macOS 适配器的固定签名身份、LaunchAgent 内容、几何与按钮诊断、审计白名单和输入标记；测试不安装真实 event tap，也不调用真实输入补发；
...
真实微信验证被刻意保留为人工发布步骤，由发布负责人使用隔离测试账号和私有测试会话完成 [人工微信验证清单](manual-wechat-validation.md)。只有对应平台清单通过后，发布记录才能声明对该 Windows/macOS 与微信版本的兼容性。
